...
class Janela(object):
    ...
    def ComponentesJL(self, ticket):
        ...
        Label(self.jlTriagem, text="Data", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.03, rely=0.07)
        ...
        Label(self.jlTriagem, text="Nota Fiscal (NF)", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.17, rely=0.07)
        ...
        Label(self.jlTriagem, text="Nº Ticket", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.31, rely=0.07)
        ...
        Label(self.jlTriagem, text="Região", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.48, rely=0.07)
        ...
        self.entryRegiao.insert(0, listaDados[6])
        self.entryRegiao.configure(state="readonly")

        Label(self.jlTriagem, text="Técnico Responsável", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.03, rely=0.15)
        ...
        self.entryTecnico.insert(0, listaDados[4])
        self.entryTecnico.configure(state="readonly")

        Label(self.jlTriagem, text="Analista Responsável", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.35, rely=0.15)
        ...
        self.entryAnalista.insert(0, listaDados[5])
        self.entryAnalista.configure(state="readonly")

        Label(self.jlTriagem, text="Cliente", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.70, rely=0.07)
        self.entryCliente = Entry(self.jlTriagem, bg=corBg, font=fonteEntry, relief="solid", bd=1)
        self.entryCliente.place(relx=0.70, rely=0.10, relwidth=0.20, height=28)
        ...
        Label(self.jlTriagem, text="Modelo do Equipamento", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.03, rely=0.23)
        ...
        self.entryEquipamento.insert(0, listaDados[7])
        self.entryEquipamento.configure(state="readonly")

        Label(self.jlTriagem, text="N° de Série (SN)", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.50, rely=0.23)
        ...
        self.entryNSerie.insert(0, listaDados[9])
        self.entryNSerie.configure(state="readonly")

        Label(self.jlTriagem, text="Peça/Equipamento Trocado", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.03, rely=0.31)
        ...
        self.entryTroca.insert(0, listaDados[10])
        self.entryTroca.configure(state="readonly")

        Label(self.jlTriagem, text="Defeito Alegado", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.03, rely=0.39)
        ...
        self.textDefeito.insert(1.0, listaDados[11])
        self.textDefeito.configure(state="disabled")

        Label(self.jlTriagem, text="Constatação do Técnico", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.03, rely=0.50)
        ...
        self.textConstatacaoTec.insert(1.0, listaDados[12])
        self.textConstatacaoTec.configure(state="disabled")

        Label(self.jlTriagem, text="Defeito Constatado (Resumo)", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.03, rely=0.61)
        ...
        self.entryDefeitoConsta.insert(0, listaDados[13])
        self.entryDefeitoConsta.configure(state="readonly")

        Label(self.jlTriagem, text="Testes Realizados", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.50, rely=0.61)
        ...
        self.entryTeste.insert(0, listaDados[14])
        self.entryTeste.configure(state="readonly")

        Label(self.jlTriagem, text="Análise do Equipamento/Peça", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.03, rely=0.69)
        ...
        self.textAnalise.insert(1.0, listaDados[15])
        self.textAnalise.configure(state="disabled")

        Label(self.jlTriagem, text="Conclusão Final", bg=corFundo, fg=corLbl, font=fonteLbl).place(relx=0.03, rely=0.80)
        ...
        self.textConclusao.insert(1.0, listaDados[16])
        self.textConclusao.configure(state="disabled")

        Button(self.jlTriagem, text="Fechar", bg="#444444", fg="white", 
                               font=("Segoe UI", 10, "bold"), relief="flat", cursor="hand2", command=self.janela.destroy).place(relx=0.72, rely=0.015, width=180, height=35)
